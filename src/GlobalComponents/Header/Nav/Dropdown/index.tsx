...
function DesktopDropdown({ dropdown }: DesktopDropdownType) {
  return (
    ...
    >
      ...
      <div
        className={`invisible w-0 flex flex-col text-neutral-900 group-hover:bg-neutral-0 group-hover:text-ps group-hover:gap-y-3 group-hover:p-6 group-hover:visible group-hover:w-[180px] group-hover:top-10 group-hover:-left-7 group-hover:transition-spacing group-hover:duration-200 group-hover:shadow-lg group-hover:drop-shadow-lg group-hover:cursor-default `}
      >
